...
<div class="main">
    <div class="changebusroute" >
      <h2>Add your desired bus route here:</h2>
          <form id="changebusroute" method="post" action="changebus">
                <label>User id: </label>
                <br>
              ...
              <label>Stopping Points:</label>
                ...
                <br><br>
                <button type="submit" name="changebusroute" id="changebusroute"style=" color:white; background-color: green;" >Enroll</button> &nbsp;
