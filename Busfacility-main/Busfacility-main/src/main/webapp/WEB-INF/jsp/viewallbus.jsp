...
<h1 style="color:white; font-family: sans-serif;text-align: center;font-weight: bold;"> ALL BUS ROUTE</h1>
...
<form ></form>
 <table  name="busroute"  class="table table-striped caption-top" style="background-color:#f8f9fa;border-radius:5px;">
                    <caption style="color:white; font-weight:bold; text-align:left;">Edit or Delete a Bus route from below list:</caption>
                    <thead>
                    <tr>
